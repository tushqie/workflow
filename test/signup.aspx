            ...
            <div class="card-body">
                <form runat="server" id="formlogin">
                    <asp:Panel ID="pnl_warning" runat="server" Visible="false">
                        ...
                        <asp:Label ID="lbl_warning" runat="server" Text="" CssClass="col-form-label text-center"></asp:Label>
                     ...
                     <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter name" ControlToValidate="txt_name" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
